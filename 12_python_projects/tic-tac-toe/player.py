...
class HumanPlayer(Player):
    ...
    def get_move(self, game):
        ...
        while not valid_square:
            ...
            # it to an integer, and it it's not, then we say it's invalid
...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        if state.current_winner == other_player:
            # we should return position AND score because we need to keep track the score for minimax to work
            return {
                    'position': None,
